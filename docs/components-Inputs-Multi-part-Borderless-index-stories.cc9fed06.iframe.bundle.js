...
`,Borderless=(0,react.memo)((props=>{const classes=[props?.className??""].join(" ");return react.createElement(react.Fragment,null,react.createElement(src_reset.A,null),react.createElement(Div,{width:props?.width??13,height:props?.height??2.5},react.createElement(Input,{...props,className:classes}),react.createElement(Label,{themeColor:props?.themeColor??"black",height:props?.height?props.height/2.3:1.1},props?.placeholder??"")))})),Multi_part_Borderless=Borderless;Borderless.__docgenInfo={description:"",methods:[],displayName:"Borderless",props:{themeColor:{required:!1,tsType:{name:"string"},description:""},invalidColor:{required:!1,tsType:{name:"string"},description:""},width:{required:!1,tsType:{name:"number"},description:""},height:{required:!1,tsType:{name:"number"},description:""}},composes:["InputHTMLAttributes"]};const index_stories={title:"Inputs/MultiPartInputs/Borderless",component:props=>{const[value,setValue]=(0,react.useState)(""),handleSetValue=(0,react.useCallback)((e=>setValue((()=>e.target.value))),[]);return react.createElement(Multi_part_Borderless,{required:!0,value,onChange:handleSetValue,...props})},parameters:{layout:"centered"},tags:["autodocs","wip"],argTypes:{themeColor:{control:"select",options:["purple","orange","green","cornflowerblue","black"],description:"Input color scheme.",defaultValue:"black"},invalidColor:{control:"text",description:"Color, when input is invalid.",defaultValue:"red"},width:{control:"number",description:"Input width.",defaultValue:13},height:{control:"number",description:"Input height.",defaultValue:2.5}},args:{}},Primary={parameters:{docs:{description:{story:"Input without styles."}}}},Stylized={parameters:{docs:{description:{story:"Added some styles."}}},args:{themeColor:"purple",invalidColor:"orange",placeholder:"login",width:13,height:2.5}},__namedExportsOrder=["Primary","Stylized"];Primary.parameters={...Primary.parameters,docs:{...Primary.parameters?.docs,source:{originalSource:'{\n  parameters: {\n    docs: {\n      description: {\n        story: "Input without styles."\n      }\n    }\n  }\n}',...Primary.parameters?.docs?.source}}},Stylized.parameters={...Stylized.parameters,docs:{...Stylized.parameters?.docs,source:{originalSource:'{\n  parameters: {\n    docs: {\n      description: {\n        story: "Added some styles."\n      }\n    }\n  },\n  args: {\n    themeColor: "purple",\n    invalidColor: "orange",\n    placeholder: "login",\n    width: 13,\n    height: 2.5\n  }\n}',...Stylized.parameters?.docs?.source}}}},"./src/reset.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>__WEBPACK_DEFAULT_EXPORT__});const __WEBPACK_DEFAULT_EXPORT__=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js").DU`
  *, *::before, *::after {
...
`}}]);
//# sourceMappingURL=components-Inputs-Multi-part-Borderless-index-stories.cc9fed06.iframe.bundle.js.map